    ...
    <div class="col-lg-12">
        ...
        <form class="col-sm-6" role="form" method="post">
            ...
            <div class="form-group clearfix {{{ $errors->has('name') ? 'has-error' : '' }}}">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" placeholder="网点" name="name" id="name" value="{{{ Input::old('name', $branch->name) }}}" />
            ...
            <div class="form-group clearfix {{{ $errors->has('contact') ? 'has-error' : '' }}}">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" placeholder="联系人" name="contact" id="contact" value="{{{ Input::old('contact', $branch->contact) }}}" />
            ...
            <div class="form-group clearfix {{{ $errors->has('mobile') ? 'has-error' : '' }}}">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" placeholder="手机" name="mobile" id="mobile" value="{{{ Input::old('mobile',$branch->mobile) }}}" />
            ...
            <div class="form-group clearfix {{{ $errors->has('address') ? 'has-error' : '' }}}">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" placeholder="地址" name="address" id="address" value="{{{ Input::old('address', $branch->address) }}}" />
