    ...
    <div class="col-lg-12">
        <form class="col-sm-6" role="form" method="post">
            ...
            <div class="form-group clearfix {{{ $errors->has('name') ? 'has-error' : '' }}}">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="线路" name="name" id="name" value="{{{ Input::old('name', $line->name) }}}" />
            ...
            <div class="form-group clearfix {{{ $errors->has('code') ? 'has-error' : '' }}}">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="编码" name="code" id="code" value="{{{ Input::old('code', $line->code) }}}" />
