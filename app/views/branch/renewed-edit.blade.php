    ...
    <div class="col-lg-12">
        ...
        <form class="col-sm-6" role="form" method="post">
            ...
            <div class="form-group clearfix {{{ $errors->has('stock') ? 'has-error' : '' }}}">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" placeholder="签订合同客户填写合同销量" name="stock" id="stock" value="{{{ Input::old('stock', $branchgood->stock) }}}" />
            ...
            <div class="form-group clearfix {{{ $errors->has('memo') ? 'has-error' : '' }}}">
                ...
                <div class="col-sm-9">
                    <textarea class="form-control" rows="5" placeholder="合同备注！" name="memo" id="memo">{{{ Input::old('memo', $branchgood->memo) }}}</textarea>
