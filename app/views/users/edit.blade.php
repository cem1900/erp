...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">修改员工信息</h1>
...
<div class="row">
    <div class="col-lg-12">
        <form class="col-sm-6" role="form" method="post" action="">
            ...
            <div class="form-group clearfix {{{ $errors->has('username') ? 'has-error' : '' }}}">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="用户名" name="username" id="username" value="{{{ Input::old('username', $user->username) }}}" />
