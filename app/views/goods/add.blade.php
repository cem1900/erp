    ...
    <div class="col-lg-12">
        ...
        <form class="col-sm-6" role="form" method="post">
            ...
            <div class="form-group clearfix {{{ $errors->has('name') ? 'has-error' : '' }}}">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" placeholder="货品名称" name="name" id="name" value="{{{ Input::old('name') }}}" />
            ...
            <div class="form-group clearfix {{{ $errors->has('barcode') ? 'has-error' : '' }}}">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" placeholder="货品条码" name="barcode" id="barcode" value="{{{ Input::old('barcode') }}}" />
            ...
            <div class="form-group clearfix {{{ $errors->has('unit') ? 'has-error' : '' }}}">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" placeholder="每箱多少瓶" name="unit" id="unit" value="{{{ Input::old('unit') }}}" />
